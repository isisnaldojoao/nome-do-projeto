...
export default function Home() {
  ...
  return (
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      ...
      <meta property="og:image" content="https://seusite.com/loudinhos_news.png" />
      <meta property="og:type" content="website" />
      <meta property="og:url" content="https://seusite.com" />
      <meta name="twitter:card" content="summary_large_image" />
      <meta name="twitter:title" content="LOUDinhos" />
      <meta name="twitter:description" content="Site sobre a LOUD e seus conteúdos" />
      <meta name="twitter:image" content="https://seusite.com/loudinhos_news.png" />
    </Head>
